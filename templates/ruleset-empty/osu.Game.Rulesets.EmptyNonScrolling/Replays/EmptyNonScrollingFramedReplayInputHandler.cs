...
{
    public class EmptyNonScrollingFramedReplayInputHandler : FramedReplayInputHandler<EmptyNonScrollingReplayFrame>
    {
        public EmptyNonScrollingFramedReplayInputHandler(Replay replay)
            : base(replay)
        {
        }
