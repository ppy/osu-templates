...
{
    public class EmptyNonScrollingDifficultyCalculator : DifficultyCalculator
    {
        public EmptyNonScrollingDifficultyCalculator(Ruleset ruleset, WorkingBeatmap beatmap)
